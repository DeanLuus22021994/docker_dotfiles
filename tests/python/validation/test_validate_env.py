...
class TestValidateEnvVars:
    ...
    def test_all_required_vars_set(
        self, _clean_env: None, _capsys: pytest.CaptureFixture[str]
    ) -> None:
        """Test validation passes when all required vars are set."""
        assert _clean_env is None  # Validate fixture executed
        assert _capsys is not None  # Validate pytest fixture
        required_vars = [
            "GITHUB_OWNER",
            "GH_PAT",
    ...
    def test_optional_vars_set(self, _clean_env: None, _capsys: pytest.CaptureFixture[str]) -> None:
        """Test optional vars are recognized when set."""
        assert _clean_env is None and _capsys is not None  # Validate fixtures
    ...
    def test_no_vars_set(self, _clean_env: None, _capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_value_masking(self, _clean_env: None, _capsys: pytest.CaptureFixture[str]) -> None:
...
class TestPrintSummary:
    ...
    def test_summary_all_valid(self, _capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_summary_missing_required(self, _capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_summary_includes_fix_instructions(self, _capsys: pytest.CaptureFixture[str]) -> None:
...
class TestMain:
    ...
    def test_main_success(self, _clean_env: None) -> None:
    ...
    def test_main_failure(self, _clean_env: None) -> None:
    ...
    def test_main_partial_vars(self, _clean_env: None) -> None:
...
class TestEdgeCases:
    ...
    def test_empty_string_values(self, _clean_env: None) -> None:
    ...
    def test_whitespace_values(self, _clean_env: None) -> None:
