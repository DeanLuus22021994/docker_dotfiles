...
**Source Research**: Template: `../research/{{date}}-{{task_description}}-research.md`
...
- **Research References**:
  - Template: `../research/{{date}}-{{task_description}}-research.md` (Lines {{research_line_start}}-{{research_line_end}}) - {{research_section_description}}
  - #githubRepo:"{{org_repo}} {{search_terms}}" - {{implementation_patterns_description}}
- **Dependencies**:
